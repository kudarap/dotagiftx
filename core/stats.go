...
type (
	...
	MarketStatusCount struct {
		...
		DeliveryNoHit          int `json:"delivery_no_hit"`
		DeliveryNameVerified   int `json:"delivery_name_verified"`
		DeliverySenderVerified int `json:"delivery_sender_verified"`
		DeliveryPrivate        int `json:"delivery_private"`
		DeliveryError          int `json:"delivery_error"`

		InventoryNoHit    int `json:"inventory_no_hit"`
		InventoryVerified int `json:"inventory_verified"`
		InventoryPrivate  int `json:"inventory_private"`
		InventoryError    int `json:"inventory_error"`
	}
