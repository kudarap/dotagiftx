...
func (app *application) setup() error {
	...
	refreshTokenStg := rethink.NewRefreshToken(rethinkClient)
	...
	authSvc := dotagiftx.NewAuthService(app.config.SigKey, steamClient, authStg, refreshTokenStg, userSvc, slogger)
