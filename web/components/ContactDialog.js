...
export default function ContactDialog(props) {
  ...
  const { market, open, onClose, variant } = props
  if (!market) {
    return null
  }
    ...
    <div>
      <Dialog
        ...
        <DialogContent>
          ...
          <Box sx={{ mt: 2 }}>
            <strong>Guides for {isSeller ? 'selling' : 'buying'} Giftables</strong>
            <Typography
              component="ul"
              variant="body2"
              color="textSecondary"
              ...
              {isSeller ? (
                <>
                  ...
                  <li>
                    As Giftables involves a party having to go first, please always check
...
ContactDialog.propTypes = {
  ...
  open: PropTypes.bool,
  variant: PropTypes.oneOf(['seller', 'buyer']),
}
