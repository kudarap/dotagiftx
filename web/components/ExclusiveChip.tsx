...
export type ExclusiveTagType = keyof typeof tagSettings

interface ExclusiveChipProps extends ChipProps {
  tag?: ExclusiveTagType
  href?: string
}

export default function ExclusiveChip({ tag, ...props }: ExclusiveChipProps) {
  if (!tag) {
    return null
  }
