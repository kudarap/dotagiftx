...
export default function Header() {
        ...
        umami.identify(userData.steam_id, {
          ...
          subscription:
            userData.subscription !== undefined
              ? USER_SUBSCRIPTION_MAP_LABEL[userData.subscription]
              : undefined,
        })
      }
  ...
  React.useEffect(() => {
    ;(async () => {
      ...
      const res = (await myProfile.GET()) as Profile
...
function AvatarMenu({ profile, onLogout }: { profile: Profile; onLogout: () => void }) {
