...
type HistoryMarket = Market & { item: Item }
...
export default function HistoryList({
  ...
  datatable: { data: HistoryMarket[]; total_count?: number }
  loading?: boolean
  error?: string | null
}) {
  ...
  const [currentMarket, setCurrentMarket] = React.useState<HistoryMarket | null>(null)
      ...
      <TableContainer component={Paper}>
        <Table aria-label="simple table">
          <TableHead>
            <TableRow>
              <TableHeadCell>
                Items ({format.numberWithCommas(datatable.total_count || 0)})
              </TableHeadCell>
              {!isMobile && (
                <>
